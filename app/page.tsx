                  ...
                  <>
                    ...
                    <div className="text-sm">
                      <p>
                        ...
                        <br />
                        <br />
                        <b>0xEntity</b> is a decentralized service based on P2P
                        IPFS - the Interplanetary File System, meaning that
                        anyone—human or AI—can make use of the seeds, ensuring
                        entities are freely accessible and available.
                        <br />
                        <br />
                        This service is <b>completely free</b> and is not tied
                        to any blockchain.{" "}
